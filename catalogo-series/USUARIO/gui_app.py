...
from model.serie_dao import crear_tabla, borrar_tabla
from model.serie_dao import Serie, guardar, listar, editar, eliminar
...
class Frame(tk.Frame):
    ...
    def campos_serie(self):
        ...
        self.entry_temporada = tk.Entry(self, textvariable=self.mi_temporada)
